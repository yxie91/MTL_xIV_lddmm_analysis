...
class JEFWorksLoader:
    ...
    def __init__(self,rootDir,res,dimEff=None,numF=None,deltaF=False,featNames=None):
        ...
        if ('.pkl' in rootDir):
            ...
            self.filenames = glob.glob(rootDir + '*cell*S1*.npz')
...
if __name__ == '__main__':
    fp = '/cis/home/kstouff4/Documents/MeshRegistration/Particles/FanMERFISH/'
    ...
    a = JEFWorksLoader(fp,[0,0,0],featNames=genes,dimEff=2,numF=31)
    ...
    a.writeAll(fp+'initialHigh_AllCells')
    #print(a.sizes)
    #print(a.numFeatures)
    #print(sum(a.sizes))
    sigma = 0.2
    ...
    a.writeSubSampled()
    a.saveToPKL(fp + 'initialHighLowAllCells.pkl')
