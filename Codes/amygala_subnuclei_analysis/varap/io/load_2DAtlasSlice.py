...
if __name__ == '__main__':
    fp = '/cis/home/kstouff4/Documents/MeshRegistration/Particles/Atlas_2D_Slices/'
    genes = np.arange(34).astype('str')
    genes = list(genes)
    
    a = AtlasSliceLoader(fp,[0,0,0],featNames=genes,dimEff=2,numF=34)
    print("filenames are: ", a.filenames)
    #a.featNames = genes
    print("feature names are:", a.featNames)
    particles,features = a.getSizes()
    #a.centerAndScaleAll()
    a.saveToPKL(fp+'initialHighMouse.pkl')
    a.writeAll(fp+'initialHigh_Mouse')
    #print(a.sizes)
    #print(a.numFeatures)
    #print(sum(a.sizes))
    sigma = 0.2
    ...
    a.writeSubSampled()
    a.saveToPKL(fp + 'initialHighLowMouse.pkl')
