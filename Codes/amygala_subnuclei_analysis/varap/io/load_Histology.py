...
if __name__ == '__main__':
    bnum = '2'
    fp = '/cis/home/kstouff4/Documents/MeshRegistration/Particles/ExVivoHuman11T/Brain3/Restain_2023/ST/AD_Hip1/allSlices_adjusted.npz'
    a = HistologyLoader(fp,[0.0,0.0,0.0],dimEff=3,fileIndex=1)
    particles,features = a.getSizes()
    a.saveToPKL(fp.replace('allSlices_adjusted.npz','initialHighAD_Hip1_500um.pkl'))
    a.writeAll(fp.replace('allSlices_adjusted.npz','initialHighAD_Hip1_500um'))
    sigma = 0.5
    a.subSampleStratified(fp,sigma,alpha=0.75)
    a.writeSubSampled()
    a.saveToPKL(fp.replace('allSlices_adjusted.npz','initialHighLowAD_Hip1_500um.pkl'))
    '''            
