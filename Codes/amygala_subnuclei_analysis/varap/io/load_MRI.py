...
if __name__ == '__main__':
    bnum = '2'
    fp = '/cis/home/kstouff4/Documents/MeshRegistration/Particles/ExVivoHuman11T/Brain3/MRI/block0.npz'
    a = MRILoader(fp,[0.125,0.125,0.125],dimEff=3,fileIndex=1)
    particles,features = a.getSizes()
    a.saveToPKL(fp.replace('block0.npz','initialHighblock0_sig1.pkl'))
    a.writeAll(fp.replace('block0.npz','initialHighblock0_sig1'))
    sigma = 1.0
    a.subSampleStratified(fp,sigma,alpha=0.75)
    a.writeSubSampled()
    a.saveToPKL(fp.replace('block0.npz','initialHighLowblock0_sig1.pkl'))
    '''            
