...
from .curveDistances import measureNorm0, measureNormDef, measureNormGradient
from .curveDistances import currentNorm0, currentNormDef, currentNormGradient
from .curveDistances import varifoldNorm0, varifoldNormDef, varifoldNormGradient
...
class SurfaceToSectionsMatching(SurfaceMatching):
    ...
    def dataTerm(self, _fvDef, var = None):
        ...
        for k,f in enumerate(fv1):
            obj += Surf2SecDist(_fvDef, f, self.fun_obj, curveDist0=self.fun_obj0, target_comp_info=self.component_structure[k])
